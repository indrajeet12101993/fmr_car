...
//    CarRentalListModel rentalListModel;
    ...
    private void fetchIntentData() {
        ...
        rentalListModel = (RideDetailModel) getIntent().getParcelableExtra("RideDetail");
