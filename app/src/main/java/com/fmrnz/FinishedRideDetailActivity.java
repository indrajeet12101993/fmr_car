...
public class FinishedRideDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finished_ride_detail);
        ...
        rideDetailModel = getIntent().getParcelableExtra("FinishedData");
...
//        upArrow = (LinearLayout) findViewById(R.id.upLayoutF);
//        downArrow = (LinearLayout) findViewById(R.id.downlayoutF);
//        content = (LinearLayout)findViewById(R.id.contentF);
//        memberRide = (TextView)findViewById(R.id.memberRide3);
//        ownerGenderRide = (TextView)findViewById(R.id.ownerGenderRide3);
        ownerNameRide = (TextView)findViewById(R.id.ownerNameRide3);
//        ownerAddRide = (TextView)findViewById(R.id.ownerAddRide3);
//        ownAboutRide = (TextView)findViewById(R.id.ownAboutRide3);
//        owncontact = (TextView)findViewById(R.id.owncontact3);
        ...
        pickLocation = (TextView)findViewById(R.id.picLocation2);
        dropLocation = (TextView)findViewById(R.id.dropLocation2);
        ...
        userrImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(FinishedRideDetailActivity.this, DialogActivity3.class);
        ...
        switch (eventType) {
            case ESNetworkRequest.NetworkEventType.END_TRIP:
                if (networkResponse.responseCode == ESNetworkResponse.ResponseCode.SUCCESS) {
                    ...
                    Intent intent = new Intent(FinishedRideDetailActivity.this, OTPActivity.class);
