...
import com.fmrnz.CancelledRideDetailActivity;
...
public class CancelledFragment extends BaseFragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        type = FragemntType.CANCELLED_FRAGMENT;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(getActivity(), CancelledRideDetailActivity.class);
                String bookId = rideDetailModel.getBook_id();
//                intent.putExtra("UpcomingData",rideDetailModel);
                intent.putExtra("CancelledData",rideDetailModel);
    ...
    private void fetchOngoingData(){
        ...
        ESAppRequest appRequest = (ESAppRequest) networkController.getNetworkRequestInstance(ESNetworkRequest.NetworkEventType.CANCELLED_FRAGMENT);
