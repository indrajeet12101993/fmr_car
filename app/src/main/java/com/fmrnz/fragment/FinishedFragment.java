...
import com.fmrnz.FinishedRideDetailActivity;
import com.fmrnz.R;
...
public class FinishedFragment extends BaseFragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        type = FragemntType.FINISHED_FRAGMENT;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(getActivity(), FinishedRideDetailActivity.class);
                String bookId = rideDetailModel.getBook_id();

                intent.putExtra("FinishedData",rideDetailModel);
    ...
    private void fetchOngoingData(){
        ...
        ESAppRequest appRequest = (ESAppRequest) networkController.getNetworkRequestInstance(ESNetworkRequest.NetworkEventType.FINISHED_FRAGMENT);
